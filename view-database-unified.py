...
################################################################################
# 
#   Here is the Windows copy of the OnSearching(sv) function. It has been 
#   commented out because I have no idea which version to use. It hasn't even
#   been formatted yet.
#
################################################################################
...
def OnSearching(sv):
    ...
    if code == '':
        ...
        if code in database.keys():
            ...
            # Dark Current
            if 'darkCurrents' in database[code].keys():
                printString='Dark Current' + '\t\t' + 'Test Date\n' 
